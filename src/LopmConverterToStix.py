...
class LopmConverterToStix:

    def __init__(self, helper: OpenCTIConnectorHelper, tlp_level: Literal["clear", "white", "green", "amber", "amber+strict", "red"],):
    ...
    def create_author():
        ...
        author = stix2.Identity(
            id=Identity.generate_id(name="LOPM-Phishing-Army-Connector", identity_class="organization"),
            name="LOPM-Phishing-Army-Connector",
            identity_class="organization",
            description="My connector for importing domain names from the Phishing Army blocklist into OpenCTI",
            external_references=[
                stix2.ExternalReference(
                    source_name="Phishing Army blocklist",
